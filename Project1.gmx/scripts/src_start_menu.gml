...
switch (mpos)
{
    ...
    case 3: room_goto(Snake_boss_room_final); global.level = 1; global.boss_beat = false; instance_create(512, 160, Player_Overworld_Object); break;
    
    case 4: room_goto(Fox_boss_room); global.level = 2; instance_create(1408, 352, Player_Overworld_Object); break;;
